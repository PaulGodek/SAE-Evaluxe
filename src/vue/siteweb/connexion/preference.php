<div class="container">
    ...
    <div class="HBox">
        <a id="adminChoice" class="button"
           href="/sae3a-base/web/controleurFrontal.php?action=afficherConnexionAdministrateur&controleur=Connexion">Compte
            Administrateur</a>
        <a id="etudiantChoice" class="button"
           href="/sae3a-base/web/controleurFrontal.php?action=afficherConnexionEtudiant&controleur=Connexion">Compte
            Étudiant</a>
