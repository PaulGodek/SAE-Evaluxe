...
class ControleurEtudiant extends ControleurGenerique
{
    ...
    public static function afficherDetail(): void
    {
        ...
        try {
            ...
            $result = ConnexionUtilisateur::estEcole()
                ? EtudiantRepository::recupererDetailsEtudiantParId($idEtudiant)
                : EtudiantRepository::recupererTousLesDetailsEtudiantParId($idEtudiant);
            ...
            self::afficherErreurEtudiant(" ");
            MessageFlash::ajouter("error", "Une erreur est survenue.");
        }
    }
